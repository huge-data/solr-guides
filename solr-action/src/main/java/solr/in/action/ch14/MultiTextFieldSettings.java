...
public class MultiTextFieldSettings {
	...
	public MultiTextFieldSettings(AnalyzerModes analyzerMode, char keyFromTextDelimiter, char multiKeyDelimiter,
			String defaultFieldTypeName, HashMap<String, String> fieldMappings, boolean ignoreMissingMappings,
			boolean removeDuplicates, boolean hidePrependedLangs) {
